...
hmm_hs_cpp_parallel <- function(G, M, phase_vec, r_start = 0.05, pi_mode = "per_marker", pi_prior_in = NULL, lambda = 20.0, epsilon = 1e-3, tol = 1e-6, maxit = 200L, paternal_mode = "per_marker", Pi_prior_in = NULL) {
    .Call(`_HSMap_hmm_hs_cpp_parallel`, G, M, phase_vec, r_start, pi_mode, pi_prior_in, lambda, epsilon, tol, maxit, paternal_mode, Pi_prior_in)
}
